...
API_KEY="dixUMbV-Mgzusq4dHxj1SIFHwX806R2R9ZSd3pRTM72e"
...
def predict():
	...
	print("hello")
	response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/a7b6d0f2-1999-4924-b4ca-88ef49ba2163/predictions?version=2022-11-15', json=payload_scoring,
	...
	if output > 0.5:
		...
		return redirect(url_for('nochance', percent=output*100)) 
